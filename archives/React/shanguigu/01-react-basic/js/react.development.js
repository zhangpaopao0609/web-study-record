  ...
  function traverseAllChildrenImpl(children, nameSoFar, callback, traverseContext) {
    ...
    if (Array.isArray(children)) {
      ...
      if (typeof iteratorFn === 'function') {
        ...
        {
          {
            throw new Error(`Objects are not valid as a React child (found: ${childrenString === '[object Object]' ? `object with keys {${Object.keys(children).join(', ')}}` : childrenString}).${addendum}`);
          }
        }
      }
    }

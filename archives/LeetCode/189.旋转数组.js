...
// 使用环状替换
function rotate(nums, k) {
  const l = count = nums.length;
  k = k % l;
  let prev = next = record = 0;
  let prevNum = nums[0]; let nextNum = null;
